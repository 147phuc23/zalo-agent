import { tool } from "ai";
import { z } from "zod";
export function createTwentySkillSearchTool(skills) {
    return tool({
        description: "Twenty skill discovery tool. Search Twenty-backed HR agent skills before loading skill docs or calling recruiting tools.",
        parameters: z.object({
...
export function createTwentySkillLoadTool(skills) {
    return tool({
