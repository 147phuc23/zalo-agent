...
const ROLES = [
  { title: "Frontend Engineer", skills: ["React", "TypeScript", "Next.js", "TailwindCSS"] },
...
async function main() {
  ...
  await client.end();
  console.log(`[seed-jobs] upserted ${inserted} jobs for tenant ${TENANT_ID} (active total: ${total})`);
}
